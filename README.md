...
| `SCRAPER_INTERVALO_MINUTOS` | `1440` | Frecuencia del scraper en minutos (24 h; `0` = desactivado) |
...
> Requiere conexión a internet. Si el scraper automático está activo (`SCRAPER_INTERVALO_MINUTOS > 0`), esto ocurre solo cada 24 horas.
...
- **Scraper cada 24 horas** (`SCRAPER_INTERVALO_MINUTOS=1440`): descarga los conciertos de agendade.com.ar e inserta los nuevos.
